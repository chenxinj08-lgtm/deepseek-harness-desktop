...
export class LlmRuntime extends Service {
  ...
  /** 跨 adapter 消息剥离结果缓存:同一消息对象只深拷贝/深冻结一次(热路径 O(1) 命中)。 */
  private readonly strippedMessages = new WeakMap<Message, Message>()
