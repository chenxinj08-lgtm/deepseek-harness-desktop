...
import { installStagedBridge } from './staged.ts'
import { installEditBridge } from './edit-state.ts'
...
export function apply(ctx: Context): void {
  ...
  ctx.effect(() => installStagedBridge(ctx), 'ui-conversation: staged-presence bridge')
  ctx.effect(() => installEditBridge(ctx), 'ui-conversation: inline-edit bridge')
