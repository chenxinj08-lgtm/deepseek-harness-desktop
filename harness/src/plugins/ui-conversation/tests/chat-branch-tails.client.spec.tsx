  ...
  switch (node.kind) {
    ...
    case 'steering':
      return (
        <UserMessageNodeView {...({
          ...props,
          renderSlot: (() => null) as unknown as React.ComponentProps<typeof UserMessageNodeView>['renderSlot'],
          useSession: (() => ({ chat: { nodes: { values: () => [] as never[] } } })) as unknown as React.ComponentProps<typeof UserMessageNodeView>['useSession'],
